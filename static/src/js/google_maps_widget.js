odoo.define('cstr_mgmt.GoogleMapsWidget', function (require) {
    "use strict";
    ...
    const GoogleMapsWidget = FieldChar.extend({
        ...
        _renderReadonly: function () {
            this.$el.html('<iframe src="' + this.value + '" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="true"></iframe>');
        },
